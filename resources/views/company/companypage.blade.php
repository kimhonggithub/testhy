...
<div class="container my-5">
    <div class="col d-flex align-items-start my-2">
        ...
        <div>
            <h3 class="fs-2 mb-3" style="color:#1383b5;">{{}}</h3>
            <div class="d-flex mb-3">
                <a class="btn py-1 px-3 " style="border-radius: 200px; background-color: aqua;font-weight: 490; ">Handyman</a>
                <a class="btn py-1 px-3 mx-2" style="border-radius: 200px; background-color: aqua; font-weight: 490; ">Electrical</a>
            </div>
            <div class="my-4">
                        ...
                        <div class="col-3 col-md-4 mt-2">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        <p class="font-weight-bold">from <b>៛{{$service->service_price}}</b></p>
                                        <div class="d-flex justify-content-center">
                                            <a href="" class=" text-black px-4 border border-success rounded-pill mx-2"><i class="fa-solid fa-pen-to-square"></i><span style="margin-left: 10px;">Edit</span></a>
                                            <a href="#" class=" text-black px-4 border border-success rounded-pill mx-2"><i class="fa-sharp fa-solid fa-trash"></i><span style="margin-left: 10px;">Delete</span></a>
                    ...
                    <form class="needs-validation" novalidate>
                        <div class="row g-3">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control rounded-pill" id="ServiceName" placeholder="service name" value="" required>
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control rounded-pill" id="Price" placeholder="Price start from" value="" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                <textarea class="form-control rounded" id="desc" rows="10" placeholder="Service Description"></textarea>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group has-validation">
                                    ...
                                    <input type="file" class="form-control rounded-pill" id="username" placeholder="Add service" required>
                                    <div class="invalid-feedback">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="https://static.vecteezy.com/system/resources/previews/008/442/086/original/illustration-of-human-icon-user-symbol-icon-modern-design-on-blank-background-free-vector.jpg" width="20px" class="rounded-circle mx-2">{{$book->user->user_fname}}&#160;{{$book->user->user_lname}}</td>
                                    <td>{{ $book->user->user_number}}</td>
                                    <td class="text-muted">{{$book->user->user_email}}</td>
                                    <td class="text-muted">{{$book->user->user_address}}</td>
                                    <td>{{$book->service->service_name}}</td>
                                    <td>{{$book->book_date}}</td>
                                    <td>
                                        <a href="#" style="color:grey"><i class="fa-sharp fa-solid fa-trash fa-lg"></i></a>
                                        <a href="#" cla style="color:grey"><i class="fa-solid fa-circle-check fa-lg mx-3"></i></a>
                                    </td>
                                </tr>
                               @endforeach
                    ...
                    <form class="needs-validation" novalidate>
                        <div class="row g-3">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control rounded-pill" id="CompanyName" placeholder="company name" value="" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-sm-6">
                                <input type="email" class="form-control rounded-pill" id="Email" placeholder="Email" value="" required>
                                <div class="invalid-feedback">
